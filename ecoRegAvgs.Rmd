...
extracting bioclim data (WorldClim data has a scale factor of 10, so Temp = -37 is -3.7 ºC.)
...
y <- y[[1]] #from list to df - note 'coverage_fraction' is how much of raster cell falls within shape
